...
const RoleSelector: React.FC = () => {
  ...
  const handleRoleSelection = (role: "patient" | "doctor" | "admin") => {
    if (role === "patient") {
      // Todos los pacientes van al onboarding primero
      navigate("/onboarding");
    } else {
  ...
  React.useEffect(() => {
    const timer = setTimeout(() => {
      switch (primaryRole) {
        ...
        case "PATIENT":
        default:
          // Pacientes van al onboarding primero
          navigate("/onboarding");
          break;
      }
    ...
    <div className="role-selector">
      <div className="role-selector-content">
        ...
        <div className="user-info">
          ...
          <p>
            Tu rol principal: <strong>{primaryRole}</strong>
          </p>
        </div>
        ...
        <div className="auto-redirect">
          <p>
            � Te redirigiremos automáticamente a tu panel principal en unos
            segundos...
          </p>
        </div>
      </div>
